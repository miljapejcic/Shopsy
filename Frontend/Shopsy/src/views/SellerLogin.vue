                ...
                <div class="col-md-6">
                    ...
                    <form @submit.prevent>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="regname" v-model="regInfo.store" placeholder="Enter company name...">
                        </div>
                        <div class="form-group">
                            <label for="name">Owner</label>
                            <input type="text" class="form-control" id="regowner" v-model="regInfo.owner" placeholder="Enter name of the owner...">
                        </div>
                        <div class="form-group">
                            <label for="username">Username</label>
    ...
    methods:{
        login(){
            if(this.loginInfo.username !== "" && this.loginInfo.password !==""){
                this.$store.dispatch("LoginSeller", this.loginInfo)
            }
            else{
        ...
        register(){
            if(this.regInfo.store !== "" && this.regInfo.owner !== "" && this.regInfo.username !== "" && this.regInfo.password !==""){
                this.$store.dispatch("RegisterSeller", this.regInfo)
            }
            else{
                alert("All fields must be filled!")
            }
